...
DELOAD_ARB_BY_VERSION[222] = DELOAD_ARB_BY_VERSION[221];   // V222 (D181): ruled UNMOVED (D181 P-SWAPDURABLE is session-store only: nothing in buildProgram, 0 engine cards change; the ruling states HALF_MANNY 0ac7da6b1691a8e1 unchanged; C1 264 C3 264 C5 0 D2 19 I3 18 carry)
E6_BY_VERSION[222] = E6_BY_VERSION[221];   // V222 (D181): ruled UNMOVED (D181 P-SWAPDURABLE is session-store only: nothing in buildProgram, 0 engine cards change; the ruling states HALF_MANNY 0ac7da6b1691a8e1 unchanged; E6 28 carries)
DELOAD_HINGE_BY_VERSION[222] = DELOAD_HINGE_BY_VERSION[221];   // V222 (D181): ruled UNMOVED (D181 P-SWAPDURABLE is session-store only: nothing in buildProgram, 0 engine cards change; the ruling states HALF_MANNY 0ac7da6b1691a8e1 unchanged; E1a 12369 E1b 9319 E3 44 G1 1275 G5 44 carry)
